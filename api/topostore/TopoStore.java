...
public abstract class TopoStore implements TopoStoreInterface {
    ...
    /**
     * Remove a topology edge from topoStore.
     * @param topoEdge a topo edge.
     */
    public void removeEdge(TopoEdge topoEdge) {
        this.topoEdges.remove(topoEdge);
        this.topoGraph.removeEdge(topoEdge);
